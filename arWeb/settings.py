...
TEMPLATES = [
    {
        ...
        "DIRS": ['C:/Users/delll/Envs/django/AR/arWeb/html',
                 'C:/Users/delll/Envs/django/AR/arWeb/static/html'],#是一个列表，用来指定除了应用目录下的模板文件夹外，Django 应该搜索模板文件的额外目录。
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
SESSION_COOKIE_SECURE = False # 在部署到生产环境时应该设置为True
